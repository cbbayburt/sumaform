...
{% if grains.get('product_version') is not none and '4.2' in grains.get('product_version') and not grains.get('server_registration_code') %}
...
{% if grains.get('product_version') is not none and '4.2-nightly' in grains.get('product_version') %}
