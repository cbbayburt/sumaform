{% if grains.get('roles') is not none and 'build_host' in grains.get('roles') and grains.get('testsuite') | default(false, true) and grains.get('osfullname') == 'SLES' and not grains.get('sles_registration_code')%}
