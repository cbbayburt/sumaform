...
testsuite_salt_packages:
  pkg.installed:
    - pkgs:
      - salt-ssh
{% if grains.get('product_version') is not none and 'head' in grains.get('product_version') or grains.get('product_version') is not none and 'uyuni-master' in grains.get('product_version') or grains.get('product_version') is not none and 'nightly' in grains.get('product_version') or grains.get('product_version') is not none and 'uyuni-pr' in grains.get('product_version') %}
