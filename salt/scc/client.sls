{% if grains.get('roles') is not none and 'client' in grains.get('roles') and grains.get('sles_registration_code') and grains.get('osrelease') is not none and '15' in grains.get('osrelease') %}
